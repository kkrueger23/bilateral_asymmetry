...
class Report(FPDF):
    ...
    def about_subject(self,subject):
        ...
        self.ln(10)
        # add about study
        with open('txt_files/about.txt', 'rb') as fh:
            txt = fh.read().decode()
    ...
    def rlsd_data(self,subject):
        ...
        self.cell(63,6,'Ankle: '+ str(round(abs(rlsd['ankle_flexion']),4))+'%',1,align='C')
        self.cell(63,6,'Knee: ' + str(round(abs(rlsd['knee_flexion']),4))+'%',1,align='C')
        self.cell(63, 6, 'Hip: ' + str(round(abs(rlsd['hip_flexion']), 4)) + '%', 1,align='C')
        self.ln(8)
        self.set_font('Arial', style='BI', size=12)
        self.cell(0, 6, 'Measures of Power:')
        self.ln()
        self.set_font('Arial', style='', size=11)
        self.cell(63, 6, 'Ankle: ' + str(round(abs(rlsd['ankle_power']), 4)) + '%', 1, align='C')
        self.cell(63, 6, 'Knee: ' + str(round(abs(rlsd['knee_power']), 4)) + '%', 1, align='C')
        self.cell(63, 6, 'Hip: ' + str(round(abs(rlsd['hip_power']), 4)) + '%', 1, align='C')
        self.ln(8)
        self.set_font('Arial', style='BI', size=12)
        self.cell(0, 6, 'Other:')
        self.ln()
    ...
    def bwsq_data(self,subject):
        ...
        self.ln()
        self.set_font('Arial',style='',size=11)
        self.cell(63,6,'Ankle: '+ str(round(abs(bwsq['ankle_flexion']),4))+'%',1,align='C')
        self.cell(63,6,'Knee: ' + str(round(abs(bwsq['knee_flexion']),4))+'%',1,align='C')
        self.cell(63, 6, 'Hip: ' + str(round(abs(bwsq['hip_flexion']), 4)) + '%', 1,align='C')
        self.ln(8)
        self.set_font('Arial', style='BI', size=12)
        self.cell(0, 6, 'Measures of Power:')
        self.ln()
        self.set_font('Arial', style='', size=11)
        self.cell(63, 6, 'Ankle: ' + str(round(abs(bwsq['ankle_power']), 4)) + '%', 1, align='C')
        self.cell(63, 6, 'Knee: ' + str(round(abs(bwsq['knee_power']), 4)) + '%', 1, align='C')
        self.cell(63, 6, 'Hip: ' + str(round(abs(bwsq['hip_power']), 4)) + '%', 1, align='C')
        self.ln(8)
        self.set_font('Arial', style='BI', size=12)
        self.cell(0, 6, 'Measures of Abduction/Adduction:')
        self.ln()
        self.set_font('Arial', style='', size=11)
        self.cell(95, 6, 'Knee: ' + str(round(abs(bwsq['knee_adduction']), 4)) + '%', 1, align='C')
        self.cell(95, 6, 'Hip: ' + str(round(abs(bwsq['hip_adduction']), 4)) + '%', 1, align='C')
        self.ln(8)
        self.set_font('Arial', style='BI', size=12)
        self.cell(0, 6, 'Other:')
        self.ln()
        self.set_font('Arial', style='', size=11)
        self.cell(95, 6, 'Medial/Lateral Knee Displacement: ' + str(round(abs(bwsq['knee_displacement']), 4)) + '%', 1,
                  align='C')
        self.cell(95, 6, 'Foot Weighting: ' + str(round(abs(bwsq['foot_weight']), 4)) + '%', 1,
                  align='C')
        self.ln(20)
    ...
    def rllun_data(self,subject):
        ...
        self.ln()
        self.set_font('Arial', style='', size=11)
        self.cell(63, 6, 'Ankle: ' + str(round(abs(rllun['ankle_flexion']), 4)) + '%', 1, align='C')
        self.cell(63, 6, 'Knee: ' + str(round(abs(rllun['knee_flexion']), 4)) + '%', 1, align='C')
        self.cell(63, 6, 'Hip: ' + str(round(abs(rllun['hip_flexion']), 4)) + '%', 1, align='C')
        self.ln(8)
        self.set_font('Arial', style='BI', size=12)
        self.cell(0, 6, 'Measures of Power:')
        self.ln()
        self.set_font('Arial', style='', size=11)
        self.cell(63, 6, 'Ankle: ' + str(round(abs(rllun['ankle_power']), 4)) + '%', 1, align='C')
        self.cell(63, 6, 'Knee: ' + str(round(abs(rllun['knee_power']), 4)) + '%', 1, align='C')
        self.cell(63, 6, 'Hip: ' + str(round(abs(rllun['hip_power']), 4)) + '%', 1, align='C')
        self.ln(8)
        self.set_font('Arial', style='BI', size=12)
        self.cell(0, 6, 'Other:')
        self.ln()
        self.set_font('Arial', style='', size=11)
        self.cell(95, 6, 'Medial/Lateral Knee Displacement: ' + str(round(abs(rllun['knee_displacement']), 4)) + '%', 1,
                  align='C')
        self.cell(95, 6, 'Foot Weighting: ' + str(round(abs(rllun['foot_weight']), 4)) + '%', 1,
                  align='C')
        self.ln(20)
    ...
    def about_concerns(self,txt_file):
        ...
        with open('txt_files/concerns_header.txt', 'rb') as fh:
            txt = fh.read().decode()
        self.set_font('Arial', style='', size=12)
        self.multi_cell(0, 5, txt)
        self.ln()
